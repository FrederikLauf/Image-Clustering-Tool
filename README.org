...
By clicking on a representative of a cluster, this cluster is singled out and re-plotted with adapted scaling, for better inspection. (The original view is recovered by clicking on "apply" or using the scoll bars.)
