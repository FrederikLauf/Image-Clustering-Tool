...
- slider "image display scaling" ::  Scale the size of the thumbnails shown in the plot.
  - check box "on release" ::  Scale the size of the thumbnails shown in the plot only on release of the slider (less performance challenging).
- button "axis off/on" :: Switch axis visibility. (Displaying the axis can be useful for estimating the eps parameter for DBSCAN.)
